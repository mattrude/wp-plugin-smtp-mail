<?php
/*
Plugin Name: wp-plugin-SMTP-Mail
Version: 0.9.2
 ...
 */
if (!function_exists('smtp_validate_email')) :
function smtp_validate_email( $email, $check_domain = true) {
    ...
    return false;
} // End of smtp_validate_email() function definition
endif;
...
function wp_mail_smtp_mail_from ($orig) {
	...
	elseif (smtp_validate_email(get_option('mail_from'), false))
...
function wp_mail_plugin_action_links( $links, $file ) {
	...
	$settings_link = '<a href="options-general.php?page=smtp-mail/wp_mail_smtp.php">' . __( 'Settings', 'wp_mail_smtp' ) . '</a>';
